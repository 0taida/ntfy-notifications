...
| `twilio-account`                           | `NTFY_TWILIO_ACCOUNT`                           | *string*                                            | -                 | Twilio account SID, e.g. ***REMOVED***                                                                                                                                                                     |
...
| `twilio-verify-service`                    | `NTFY_TWILIO_VERIFY_SERVICE`                    | *string*                                            | -                 | Twilio Verify service SID, e.g. ***REMOVED***                                                                                                                                                              |
...
| `message-limit`                            | `NTFY_MESSAGE_LIMIT`                            | *number*                                            | -                 | The size limit (in bytes) for the ntfy message. NOTE: FCM has size limit at 4000 bytes. APNS has size limit at 4KB. If you increases this size limit, FCM and APNS will NOT work for large messages.                                                      |
